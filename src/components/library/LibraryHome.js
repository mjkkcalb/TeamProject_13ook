...
const LibraryHome = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // 베스트셀러 API 호출
        const bestSellerResponse = await axios.get("/library/best");
  ...
  return (
    <div className={Liby.library}>
      ...
      <div className={Liby.liby}>
        ...
        <p className={Liby.arrow}>
          <BiArrowBack />
        </p>
      </div>
      <img src={`${publicUrl}/images/peo.svg`} alt="peo" className={Liby.peo} />
